...
def batchify_joint(
    ...
    def optimizer(
        ...
        vectorized_points, vectorised_child_results = batch_size_one_optimizer(  # [1, B * D]
            expanded_search_space, target_func_with_vectorized_inputs
        )
        return tf.reshape(vectorized_points, [batch_size, -1]), vectorised_child_results  # [B, D]
